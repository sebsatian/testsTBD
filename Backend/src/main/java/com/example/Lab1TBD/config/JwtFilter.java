...
public class JwtFilter extends OncePerRequestFilter {
    private final com.example.Lab1TBD.config.JwtUtil jwtUtil;
    private final UserDetailsService userDetailsService;

    @Autowired
    public JwtFilter(com.example.Lab1TBD.config.JwtUtil jwtUtil, UserDetailsService userDetailsService) {
